...
public abstract class Connection {
    ...
    public Connection(Socket socket) throws IOException {
        Console.log(ConsoleColour.GRAY + "[Socket] Connecting to socket " + socket.getLocalAddress() + " " + socket.getPort());
        ...
        Console.log(ConsoleColour.GRAY + "[Socket] Connected to " + socket.getInetAddress());
    }
    ...
    public Connection(String host, int port) throws IOException {
        Console.log(ConsoleColour.GRAY + "[Socket] Connecting to socket " + host + " " + port);
        ...
        Console.log(ConsoleColour.GRAY + "[Socket] Connected to " + host + " " + port);
    }
    ...
    public void send(String data) {
        ...
        if (this.debugMode) Console.log(ConsoleColour.GRAY + "[Socket] Sending data: " + data);
    }
    ...
    public String read() throws IOException {
        ...
        if (this.debugMode) Console.log(ConsoleColour.GRAY + "[Socket] Reading data: " + data);
